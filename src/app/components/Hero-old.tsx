      ...
      <div className="container hero__inner" style={{ zIndex: 10, position: 'relative' }}>
        ...
        <div className="hero__slider" data-aos="fade-up" data-aos-delay="500">
            ...
            {featuredProjects.map((project, index) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `url(${process.env.NEXT_PUBLIC_STORAGE_URL}/${project.image})`,
          ...
          {/* <div className="slider__nav" id="sliderNav">
            <span className={`slider__dot${activeSlide === 0 ? ' is-active' : ''}`} data-i="0" onClick={() => goTo(0)}></span>
            <span className={`slider__dot${activeSlide === 1 ? ' is-active' : ''}`} data-i="1" onClick={() => goTo(1)}></span>
            <span className={`slider__dot${activeSlide === 2 ? ' is-active' : ''}`} data-i="2" onClick={() => goTo(2)}></span>
          </div> */}
          <div className="slider__nav" id="sliderNav">
