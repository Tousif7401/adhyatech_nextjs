...
const RealisticMoon = ({ onClick }: { onClick?: () => void }) => {
  ...
  const colorMap = useTexture("https://raw.githubusercontent.com/mrdoob/three.js/r128/examples/textures/planets/moon_1024.jpg");
...
const AsteroidBelt = ({ ringState, massiveAsteroidsRef }: { ringState: 'hidden' | 'animating' | 'visible', massiveAsteroidsRef: React.MutableRefObject<Float32Array> }) => {
  ...
  const [colorMap, bumpMap] = useTexture([
    'https://raw.githubusercontent.com/mrdoob/three.js/r128/examples/textures/planets/moon_1024.jpg',
    'https://raw.githubusercontent.com/mrdoob/three.js/r128/examples/textures/planets/moon_1024.jpg'
  ]);
...
export default function LunarScene() {
  ...
  // Auto-trigger animation after 1 second
  React.useEffect(() => {
  ...
  return (
    <div className="w-full h-full bg-black relative">
      <div className="absolute bottom-4 left-4 z-10">
        <div className="text-6xl font-bold text-yellow-400">2010</div>
        <p className="text-sm mt-1" style={{ color: '#cbd5e1' }}>Founded in Ballari, Karnataka.<br />Still here. Still hiring.</p>
      </div>
      <Canvas shadows camera={{ position: [3.5, -1, -10.5], fov: 45 }} dpr={[1, 2]}>
...
export { LunarScene as Component };
