        ...
        <div className={cn("relative", className)}>
            ...
            >
                ...
                <path
                    ...
                    className="fill-[#262626] dark:fill-[#1a1a1a] dark:drop-shadow-sm"
                />
                <path
                    d="M249 48.5C249 42.701 253.701 38 259.5 38C265.299 38 270 42.701 270 48.5C270 54.299 265.299 59 259.5 59C253.701 59 249 54.299 249 48.5Z"
                    className="fill-[#262626] dark:fill-[#0a0a0a]"
                />
                <path
                    d="M254 48.5C254 45.4624 256.462 43 259.5 43C262.538 43 265 45.4624 265 48.5C265 51.5376 262.538 54 259.5 54C256.462 54 254 51.5376 254 48.5Z"
                    className="fill-[#262626] dark:fill-[#000000]"
                />
                {/* highlight */}
                <path
...
export const PhoneCarousel: React.FC<PhoneCarouselProps> = ({
    ...
    // Immediately advance when hover ends
    useEffect(() => {
        if (!isHovering && !isPaused && !featureMode) {
            const timeout = setTimeout(() => {
                setCurrentIndex((prevIndex) => (prevIndex + 1) % images.length);
            }, 100); // Small delay for smooth transition
            return () => clearTimeout(timeout);
        }
    }, [isHovering, isPaused, featureMode, images.length]);
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="relative">
                    ...
                    <div
                        ref={carouselRef}
                        className="flex justify-center items-start h-[450px] md:h-[500px] lg:h-[550px]"
                                ...
                                return (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            (isPrevious || isNext) ? "cursor-pointer" : ""
                                        )}
                                        style={{
                                            top: "0",
                                        ...
                                        onClick={() => (isPrevious || isNext) && setCurrentIndex(index)}
                                    >
                                        <div className="group">
                                            <Iphone15Pro
                                                width={isMobile ? 200 : 240}
